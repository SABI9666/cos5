...
const HomePage = ({ onCartClick, cartCount }) => {
  ...
  const categories = [
    {
      ...
      image: 'https://images.unsplash.com/photo-1600375739037-ae4f0b32e340?w=800',
      ...
      <section className="hero-section">
        ...
        <div className="hero-content">
          <h1 className="hero-title">
            Illuminate Your <span className="highlight">World</span>
          </h1>
      ...
      <section className="section features-section">
        <div className="features-grid">
          <div className="feature-card">
            ...
            <p>Save up to 80% on energy costs with our LED technology</p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
            ...
            <h3>Smart Control</h3>
            <p>WiFi-enabled control via smartphone or voice assistants</p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
            ...
            <h3>Long Lifespan</h3>
            <p>Rated for 50,000+ hours of reliable operation</p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
            ...
            <p>2-year warranty on all premium LED products</p>
          </div>
        </div>
      </section>
